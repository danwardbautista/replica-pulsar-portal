...
@Component({
  ...
  template: `
    ...
    <div class="col">
      <h3 style="font-size: 150%;" class="mb-3"><span
                                                      class="ng-tns-c97-3 ng-trigger ng-trigger-fadeField ng-star-inserted"> 16192150177 <a
        class="ng-tns-c97-3" href=""><fa-icon
                                              class="ng-fa-icon"><svg
        ...
        <!----><!----><span class="d-block ng-star-inserted"><small
          style="font-size: 60%;" class="ng-tns-c97-3 text-danger"><!----><fa-icon
          class="ng-fa-icon ng-star-inserted"><svg role="img" aria-hidden="true"
                                                   focusable="false"
                                                   data-prefix="far"
          ...
          <!----> Offline</small><small style="font-size: 60%;"
                                        class="ng-tns-c97-3"> - </small><small _ngcontent-xxk-c97=""
                                                                               class="text-muted"
                                                                               style="font-size: 60%;">16192150177</small></span>
        <!----><!----></h3>
      <div class="mb-3"><!---->
        <button class="btn btn-sm btn-success mr-4 ng-star-inserted">
          <fa-icon class="ng-fa-icon mr-1 d-none">
      ...
      <div ngbAccordionItem [collapsed]="false">
        ...
        <div ngbAccordionCollapse>
          <div ngbAccordionBody>
            ...
            <dl class="row mb-0"><!----><!---->
              <dt class="col-sm-3 text-right">Alert Profile(s)</dt>
              <dd class="col-sm-9"><span _ngcontent-xxk-c97=""
                                         class="ng-tns-c97-3 ng-trigger ng-trigger-fadeField ng-star-inserted"><span
                class="mr-1 ng-star-inserted" style=""><fa-icon _ngcontent-xxk-c97=""
                                                                class="ng-fa-icon"><svg
                ...
                <!----><!----><a style="font-size: 80%;" class="ng-tns-c97-3" href=""><fa-icon
              ...
              <dd class="col-sm-9"><span _ngcontent-xxk-c97=""
                ...
                <!----><a class="mr-1 ng-star-inserted" href="/bar-profile/1845"
                          style=""><fa-icon class="ng-fa-icon"><svg role="img"
                                                                    aria-hidden="true"
                                                                    focusable="false"
                                                                    data-prefix="far"
                                                                    data-icon="lock"
              ...
              <dd class="col-sm-9 ng-star-inserted"><span _ngcontent-xxk-c97=""
                                                          class="text-danger font-weight-bold"><fa-icon
                class="ng-fa-icon"><svg role="img" aria-hidden="true"
                                        focusable="false" data-prefix="far"
              ...
              <dt class="col-sm-3 text-right">Domain Filter Profile</dt>
              <dd class="col-sm-9 ng-star-inserted"><span _ngcontent-xxk-c97=""
                                                          class="text-danger font-weight-bold"><fa-icon
                class="ng-fa-icon"><svg role="img" aria-hidden="true"
                                        viewBox="0 0 384 512"><path
